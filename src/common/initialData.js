...
export const initialFilters = {
  bouquetComposition: {
    ...
    options: [
      ...
      { name: "Лилия", value: "lilies", count: 10 },
  ...
  features: {
    name: "Особенности",
    options: [
      { name: "Ароматные", value: "fragrant", count: 16 },
      { name: "Гипоаллергенные", value: "hypoallergenic", count: 19 },
      { name: "Экзотические", value: "exotic", count: 14 },
      { name: "Бенто-торт", value: "bentoCake", count: 1 },
    ],
  },
  price: {
    name: "Цена",
